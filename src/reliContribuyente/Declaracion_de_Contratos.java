...
public class Declaracion_de_Contratos {
	...
	@Test
	public void test_alquiler_bienes_inmuebles_urbanos() throws InterruptedException {
...
//}
   ...
   // driver.switchTo().window(vars.get("root").toString());
	...
	@Test
	public void test_arrendamientos_bienes_inmuebles_rurales() throws InterruptedException {
...
//	wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='27363591715']/div/div[2]/h3")));
	...
	*/
	...
	Thread.sleep(500);
	driver.findElement(By.id("rbRural")).click();
   // driver.findElement(By.id("modalMensajeBtnOK")).click();
    Thread.sleep(1000);
    driver.findElement(By.id("rbRural")).click();
    Thread.sleep(1000);
...
//}
   ...
   // driver.switchTo().window(vars.get("root").toString());
	...
	@Test
	public void test_alquiler_temporario_inmuebles_urbanos() throws InterruptedException {
...
//	wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='27363591715']/div/div[2]/h3")));
   ...
   // driver.findElement(By.id("modalMensajeBtnOK")).click();
    Thread.sleep(1000);
    driver.findElement(By.id("rbTuristicoUrbano")).click();
    Thread.sleep(1000);
    driver.findElement(By.id("rbSubLocacionSi")).click();
    Thread.sleep(1000);
   // driver.findElement(By.id("btnSiguiente")).click();
...
//}
   ...
   // driver.switchTo().window(vars.get("root").toString());
	...
	@Test
	public void test_alquiler_temporario_inmuebles_rurales() throws InterruptedException {
...
//}
   ...
   // driver.switchTo().window(vars.get("root").toString());
	...
	@Test
	public void test_alquiler_espacios_superficies_fijas_moviles() throws InterruptedException {
...
//	wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='27363591715']/div/div[2]/h3")));
	...
	*/
    ...
    //INGRESO CON CUIT CONTRIBUYENTE HOMO 
	driver.findElement(contribuyente2_Locator).click();
	Thread.sleep(2000);
	driver.get("https://srvrome.homo.afip.gob.ar/fiscalizacion/reli/app/contrato/DeclaracionContrato.aspx");
	Thread.sleep(2000);
	driver.findElement(decla_contratoLocator).click();
	...
	//Alquiler temporario de bienes Inmuebles Rurales o Urbanos
	driver.findElement(By.id("rbEspacios")).click();
   // driver.findElement(By.id("modalMensajeBtnOK")).click();
    Thread.sleep(1000);
    driver.findElement(By.id("lblLocadorYPropietario")).click();
    Thread.sleep(1000);
    //driver.findElement(By.id("rbSubLocacionSi")).click();
    //Thread.sleep(1000);
    //driver.findElement(By.id("btnSiguiente")).click();
    ...
    driver.findElement(By.id("txtCuitResidente")).click();
    Thread.sleep(1000);
    driver.findElement(By.id("txtPorcTitularidad")).sendKeys("100");
    Thread.sleep(1000);
    driver.findElement(By.id("txtPorcLocacion")).sendKeys("100");
    driver.findElement(By.cssSelector("#footer-wait .col-md-12")).click();
    driver.findElement(By.id("btnAgregarLocador")).click();
  ...
  //  driver.findElement(By.id("btnSiguiente")).click();
    ...
    driver.findElement(By.id("txtPiso")).sendKeys("6");
    driver.findElement(By.id("txtDepto")).sendKeys("C");
    driver.findElement(By.id("txtUnidadFuncional")).sendKeys("234455");
    driver.findElement(By.id("cboProvincia")).click();
    {
      WebElement dropdown = driver.findElement(By.id("cboProvincia"));
      dropdown.findElement(By.xpath("//option[. = 'BUENOS AIRES']")).click();
    ...
    driver.findElement(By.id("btnSiguiente")).click();
    driver.findElement(By.id("rbMultipleDomicilioNo")).click();
    driver.findElement(By.id("txtIdentificacionLocal4")).sendKeys("Puesto 001");
    driver.findElement(By.id("cboSuperficie")).click();
    {
      WebElement dropdown = driver.findElement(By.id("cboSuperficie"));
      dropdown.findElement(By.xpath("//option[. = 'Supermercado']")).click();
    }
   ...
   // driver.findElement(By.id("dtpFechaCelebracion")).click();
    driver.findElement(By.id("dtpFechaInicio")).click();
    driver.findElement(By.id("txtDuracionMeses")).sendKeys("6");
    driver.findElement(By.cssSelector(".fa-plus")).click();
    Thread.sleep(1500);
    //driver.findElement(By.id("rbModalidadDinero")).click();
    driver.findElement(By.id("cboFrecuenciaPago")).click();
